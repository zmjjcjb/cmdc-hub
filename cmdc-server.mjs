...
const ALL_MODELS = [
    ...
    {
        id: 'minimax-m3-free',
        upstreamId: 'MiniMaxAI/MiniMax-M3-Free',
        category: 'MiniMax',
        tag: '完全免额度',
        note: 'MiniMax 官方免额度通道 · 不扣月包',
        price: '免费 (0 积分)',
        runs: 999999,
        isFree: true,
        context: '1M',
    ...
    },
    {
        ...
        category: '小米',
        tag: '98%特惠',
        note: '官方限时 98% 折扣 · 极低资费 $0.14 入 / $0.28 出',
        price: '$0.14 / 1M (98%折扣)',
        runs: 30100,
        context: '1M',
        maxTokens: '131072',
    ...
    },
    {
        ...
        category: 'Meta',
        tag: '90%折扣',
        note: '仅需 dsv4f 的 1/3 价格！$0.10 入 / $0.20 出【敏感内容勿用】',
        price: '$0.10 / 1M (极便宜)',
        runs: 22800,
        context: '1M',
    ...
    },
    {
        ...
        category: '小米',
        tag: '98%特惠',
        note: '原价 $2.00/$6.00 · 特惠仅 $0.435 入 / $0.87 出',
        price: '$0.435 / 1M (98%折扣)',
        runs: 12000,
        context: '1M',
        maxTokens: '131072',
        protocol: 'Chat Completions',
    ...
    },
    {
        ...
        category: 'DeepSeek',
        tag: '基准主力',
        note: '谷时 $0.22/$0.66 · 峰时 $0.44/$1.32 (UTC 01-04/06-10)',
        price: '谷时 $0.22 / 峰时 $0.44',
        runs: 7600,
        highlight: true,
        context: '1M',
    ...
    },
    {
        ...
        category: 'OpenAI',
        tag: '轻量特化',
        note: '$0.20 入 / $1.20 出 (2x usage 折扣)',
        price: '$0.20 / 1M',
        runs: 4100,
        context: '1.1M',
        maxTokens: '65536',
    ...
    },
    {
        ...
        category: 'MiniMax',
        tag: '5折大促',
        note: '原价 $0.60/$2.40 · 官方 5 折特惠 $0.30 入 / $1.20 出',
        price: '$0.30 / 1M (5折)',
        runs: 3200,
        context: '1M',
        maxTokens: '131072',
    ...
    },
    {
        ...
        category: 'Kimi',
        tag: '代码特化',
        note: '$0.95 入 / $4.00 出 · 编程/Debug 特化优化',
        price: '$0.95 / 1M',
        runs: 1800,
        context: '256K',
        maxTokens: '131072',
    ...
    },
    {
        ...
        category: 'DeepSeek',
        tag: '深度推理',
        note: '顶阶思考 · 谷时 $0.66/$1.98 · 峰时 $1.32/$3.96',
        price: '谷时 $0.66 / 峰时 $1.32',
        runs: 1050,
        context: '1M',
        maxTokens: '200000',
        protocol: 'Chat Completions',
    ...
    },
    {
        ...
        category: 'Kimi',
        tag: '2M超长上下文',
        note: '$3.00 入 / $15.00 出 · 200万上下文最强逻辑大脑',
        price: '$3.00 / 1M',
        runs: 110,
        context: '2M',
        maxTokens: '131072',
